...
type EulaScreenNavigationProp = StackNavigationProp<RootStackParamList, 'Eula'>;

const EulaScreen = () => {
    const navigation = useNavigation<EulaScreenNavigationProp>();

    const handleAgree = async () => {
        await AuthService.setEulaAccepted();
        // Navigate to Login after EULA
